                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center">
                                                <a href="<?=base_url()?>pasien/detail?nidn=<?php echo $data['nidn'] ?>"
                                                    class="btn btn-xs btn-info" title="Lihat">
                                                    <i class="fa fa-eye"></i>
                                                </a>
                                                <a href="<?=base_url()?>pasien/ubah?nidn=<?php echo $data['nidn'] ?>"
                                                    class="btn btn-xs btn-warning" title="Ubah">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                                <a href="<?=base_url()?>pasien/hapus?nidn=<?php echo $data['nidn'] ?>"
