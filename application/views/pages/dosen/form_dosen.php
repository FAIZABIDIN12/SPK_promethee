                            ...
                            <div class="panel-body">
                                <form action="" method="post">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-lg-9">
                                            <select id="id_umur" name="id_umur" class="form-control" required>
                                    ...
                                    <script>
                                        document.getElementById('id_umur').addEventListener('change', function() {
                                            ...
                                            fetch('<?php echo base_url('Pasien/getUmurData/') ?>' + selectedUmurId)
                                    ...
                                    <div class="row form-group stunting-class">
                                        <div class="col-lg-3">
